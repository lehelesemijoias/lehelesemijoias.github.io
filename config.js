/* ============================================================
   VITRINE LE HELÊ — configuração
   Preencha as 3 linhas abaixo (o guia mostra onde achar cada uma).
   A chave "publishable" / "anon public" pode ficar aqui sem problema:
   quem protege os dados são as regras de segurança do Supabase.
   ============================================================ */
window.LEHELE = {
